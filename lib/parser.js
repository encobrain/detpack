...
var OneofStruct = require('./types/oneof').Struct,
...
function parse (text) {
    ...
    function setOneofType (typeName) {
        ...
        var props = new OneofStruct(), prop;
    ...
    while (i < l) {
        ...
        if (types[name]) throw newError('Type "'+name+'" already exists');
