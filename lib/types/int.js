...
function encodeList (numbers, buffer) {
    ...
    if (length < this._listMin)
        throw new Error('Required minimum ' + this._listMin + ' Int numbers');

    if (length > this._listMax)
        throw new Error('Allow maximum ' + this._listMax + ' Int numbers');
...
function checkDefaultList (numbers, propDesc) {
    ...
    if (length < this._listMin)
        throw new Error('Incorrect default. Required minimum ' + this._listMin + ' Int numbers in ' + propDesc);

    if (length > this._listMax)
        throw new Error('Incorrect default. Allow maximum ' + this._listMax + ' Int numbers in ' + propDesc);
...
function decode (buffer, inited) {
    ...
    if (i === max) throw new Error('Int bytes error');
...
IntType.prototype._listMin = null;
IntType.prototype._listMax = null;
