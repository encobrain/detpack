...
function encodeList (numbers, buffer) {
    ...
    if (length < this._listMin)
        throw new Error('Required minimum ' + this._listMin + ' Num numbers');

    if (length > this._listMax)
        throw new Error('Allow maximum ' + this._listMax + ' Num numbers');
...
function checkDefaultList (numbers, propDesc) {
    ...
    if (length < this._listMin)
        throw new Error('Incorrect default. Required minimum ' + this._listMin + ' Num numbers in ' + propDesc);

    if (length > this._listMax)
        throw new Error('Incorrect default. Allow maximum ' + this._listMax + ' Num numbers in ' + propDesc);
}
...
NumType.prototype._listMin = null;
NumType.prototype._listMax = null;
